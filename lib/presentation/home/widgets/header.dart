...
class Header extends StatelessWidget {
  ...
  Widget _profileImage(UserEntity user, BuildContext context) {
    return GestureDetector(
      onTap: () {
        AppNavigator.push(context: context, widget: const SettingsPage());
      },
      child: Container(
        height: 40,
        width: 40,
  ...
  Widget _cart(BuildContext context) {
    return GestureDetector(
      onTap: () {
        AppNavigator.push(context: context, widget: CartPage());
      },
      child: Container(
        height: 40,
        width: 40,
  ...
  // Shimmer loading effect widget for the header
